...
void setup() {
  ...
  // We attenuate the MID channel a little to prevent saturation when increasing
  // the SIDE channel gain
  mixer1.gain(0, 0.9);
  // We increase the gain of the SIDE channel to increase stereo width
  mixer2.gain(0, 2.0);
  // But, we remove low frequencies from the side channel. Better for sub and
  // doesn't get your ears twinkling with out-of-phase basses using a headphone
