...
void setup() {
  ...
  audioShield.enhanceBassEnable();  // all we need to do for default bass
  ...
  // please see http://www.pjrc.com/teensy/SGTL5000.pdf page 50 for valid values
  // for BYPASS_HPF and CUTOFF
}
